...
DELIMITER $$
CREATE PROCEDURE AddNewCustomer(IN inFirstName VARCHAR(100), IN inLastName VARCHAR(100), IN inEmail VARCHAR(100))
     BEGIN 
...
CALL AddNewCustomer('KEVIN', 'HALL', 'KEVIN.HALL@example.com');
