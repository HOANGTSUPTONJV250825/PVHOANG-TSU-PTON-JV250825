...
DELIMITER $$
CREATE PROCEDURE GetCustomerTotalRevenue( IN inCustomerID INT, IN inStartDay DATE, IN inEndDate DATE)
   BEGIN
        DECLARE sumProfit DECIMAL(10,2) DEFAULT 0;
        ...
        BETWEEN inStartDay 
        AND inEndDate;
		SELECT sumProfit AS TotalRevenue;
   END $$ 
DELIMITER ;
